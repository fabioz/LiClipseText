...
public abstract class AbstractCompletionProposalExtension extends LiClipseCompletionProposal implements
        ICompletionProposalExtension2, ICompletionProposalExtension {

    private LiClipseCompletionPresentationUpdater presentationUpdater;
    ...
    protected LiClipseCompletionPresentationUpdater getPresentationUpdater() {
        if (presentationUpdater == null) {
            presentationUpdater = new LiClipseCompletionPresentationUpdater();
        }
