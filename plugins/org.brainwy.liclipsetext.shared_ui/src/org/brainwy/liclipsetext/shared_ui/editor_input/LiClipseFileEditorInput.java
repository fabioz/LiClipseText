 ...
 * @author Fabio
 */
public class LiClipseFileEditorInput implements IPathEditorInput, ILocationProvider, ILocationProviderExtension,
    ...
    private static class WorkbenchAdapter implements IWorkbenchAdapter {
        ...
        public String getLabel(Object o) {
            return ((LiClipseFileEditorInput) o).getName();
        }
    ...
    public LiClipseFileEditorInput(File file) {
        super();
        fFile = file;
    ...
    public IPath getPath(Object element) {
        if (element instanceof LiClipseFileEditorInput) {
            LiClipseFileEditorInput input = (LiClipseFileEditorInput) element;
