package org.brainwy.liclipsetext.shared_core.string;
...
public class FastStringBufferTest extends TestCase {
    ...
    public void testReplaceLast() throws Exception {
		assertEquals(new FastStringBuffer("foo",0).replaceLast("o", "").toString(), "fo");
		assertEquals(new FastStringBuffer("foo",0).replaceLast("oo", "").toString(), "f");
		assertEquals(new FastStringBuffer("foo",0).replaceLast("f", "ww").toString(), "wwoo");
		assertEquals(new FastStringBuffer("foo",0).replaceLast("bar", "ww").toString(), "foo");
		assertEquals(new FastStringBuffer("foo",0).replaceLast("o", "ww").toString(), "foww");
	}
